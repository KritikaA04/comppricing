...
async function test(){
    ...
    //  arr.push(obj)
    //  console.log(arr)
    const divprice = $('div.blackText.fontSize18.blackFont.white-space-no-wrap.clusterViewPrice')
    divprice.each((i,div) => {
        console.log($(div).text());
    })
    // await page.locator(selector,'[class=blackText.fontSize18.blackFont.white-space-no-wrap.clusterViewPrice]')
    await browser.close();
}
